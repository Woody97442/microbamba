...
const Index: React.FC = () => {
  ...
  if (products.length > 0) {
    ...
    return (
      <div className="flex flex-col items-center justify-center bg-[#e9e9e9] h-screen gap-5">
        <h1 className="text-6xl font-primary">MICROBAMBA</h1>
        <div className="flex flex-row gap-4">
          <ImPacman className="text-6xl text-yellow-400" />
          <div className="flex flex-row">
            <span className="loading loading-dots loading-lg text-red-600"></span>
            <span className="loading loading-dots loading-lg text-red-600"></span>
          </div>
          <FaGhost className="text-6xl text-cyan-500" />
          <FaGhost className="text-6xl text-red-600" />
          <FaGhost className="text-6xl text-orange-400" />
          <FaGhost className="text-6xl text-pink-400" />
        </div>
      </div>
    );
  }
